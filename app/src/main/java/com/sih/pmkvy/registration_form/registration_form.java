...
public class registration_form extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    public void onClick(View v) {
        if (Check_data()) {
            ...
            try {
                add.put("c_name", name);
                add.put("c_email_id", mail);
                add.put("c_alternate_email_id", "");
                add.put("c_contact_number", contact);
                add.put("c_alternate_contact_number", "");
                add.put("c_address", street);
                add.put("c_state_ut", state);
                add.put("c_district", district);
                add.put("c_pincode", pincode);
                add.put("c_alternate_address", "");
                add.put("c_alternate_state", "");
                add.put("c_alternate_district", "");
                add.put("c_alternate_pincode", "");
                add.put("c_date_of_birth", dob);
                add.put("c_f_name", fname);
                add.put("c_gender", gender_radio.getText().toString());
                add.put("c_category", rcategory.getSelectedItem().toString());
                add.put("c_differently_abled", disabled);
                add.put("c_is_bpl",bpl);
                add.put("c_annual_family_income",income);
                add.put("c_educational_qualification",qualification);
                //add.put("c_work_experience_months",)
